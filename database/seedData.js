...
export const initialData = {
    ...
    projects : [
        ...
        },
        {
            ...
            description: "Desarrollo de tienda Online en Next.js, contiene  un dasboard con sistema de login para cliente Admin y Crud de productos. Los estilos fueron con SASS ",
        ...
        },
        {
            ...
            description: "Sitio web creado para escritorio jurídico en Argentina ciudad de Córdoba. Se utilizo figma para wireframe. Maquetado con Hmtl, Css y Javascript.",
        ...
        },
        {
            ...
            description: "Aplicación creada con React. Se utilizó redux para manejo del state, manejo de login (registro, inicio de sesión y logout). CRUD de eventos en un calendario mediante peticiones HTTP a una API REST creada con Node.js y Mongodb",
    ...
    
        {
            ...
            description: "E-commerce creada en React. Conexión a Firebase para manejo de consultas y persistencia de datos, los estilos se crearon con SASS.",
            technologies:['React', 'SASS', 'Firebase'],
          ...
          
        {
            ...
            description: "Página web para una tienda de cafetería con Html y SASS, con cinco secciones cada una de ellas adaptadas en responsive con mobile first.",
...

        {
            ...
            description: "Juego de blacjack creado con javascript, HTML y Css. Te permite desafiar una computadora y probar tu suerte.",
        ...
        },
        {
            ...
            description: "Aplicación construida con Static Generated gracias a Next.js, los estilos se diseñaron con Next UI y la información se maneja mediante el Poke Api.",
